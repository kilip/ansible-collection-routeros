            ...
            "options": {
                ...
                "stp": {
                    ...
                    "options": {
                        ...
                        "priority": {"type": "str"},  # actual type is hex
                ...
                # unknown sections
                "add_dhcp_option82": {"type": "bool", "default": None},
                "igmp_version": {"choices": [1, 2], "type": "int"},
                "querier_interval": {"type": "int"},
                "disabled": {"type": "bool"},
