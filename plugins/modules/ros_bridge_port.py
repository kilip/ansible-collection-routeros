    ...
    state:
        ...
        description: |
            ...
            -  When Resource Exists:
               *  M(ros_bridge_port) will update existing C(/interface bridge port) configuration
            -  When Resource Not Exists:
               *  M(ros_bridge_port) will create new C(/interface bridge port),
            Replaced
            -  When Resource Exists:
               *  M(ros_bridge_port) will restore related C(/interface bridge port) to its default value.
               *  M(ros_bridge_port) will update C(/interface bridge port) item using the passed C(argument_spec).
            -  When Resource Not Exists:
               *  M(ros_bridge_port) will create new C(/interface bridge port)
            Overridden:
            *  M(ros_bridge_port) will remove any existing item in C(/interface bridge port)
            *  M(ros_bridge_port) will create new item using value in the C(argument_spec)
            Deleted:
            ----
            *  If item exists M(ros_bridge_port) will remove that item from C(/interface bridge port) configuration
    config:
        ...
        suboptions:
            ...
            bpdu_guard:
                ...
                description: |
                    ...
                    property has no effect when protocol-mode is set to C(none).
            bridge:
                type: str
                required: True
                description: |
            ...
            edge:
                ...
                description: |
                    ...
                    forwarding state.
                    - C(auto) - same as C(no-discover), but will additionally detect if bridge port
            ...
            external_fdb:
                ...
                description: |
                    ...
                    C(yes) will disable MAC learning and the bridge will act as a hub (disables
            ...
            learn:
                ...
                description: |
                    ...
                    if the L(Wireless
                    interface,https://wiki.mikrotik.com/wiki/Manual:Interface/Wireless) is disabled.
            multicast_router:
                type: str
                ...
                description: |
                    ...
                    a C(multicast-router) IPTV might not work properly, it can be either be detected
            ...
            horizon:
                ...
                description: |
                    ...
                    Read more about L(Bridge split
            ...
            point_to_point:
                ...
                description: |
                    ...
                    single link, by setting this property to C(no), you are expecting that a link
                    can receive BPDUs from multiple devices. By setting the property to C(yes), you
                    are significantly improving (R/M)STP convergence time. In general, you should
                    only set this property to C(no) if it is possible that another device can be
                    connected between a link, this is mostly relevant to Wireless mediums and
                    Ethernet hubs. If the Ethernet link is full-duplex, C(auto) enables
