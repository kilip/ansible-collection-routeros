        ...
        suboptions:
            add_arp:
                ...
                choices:
                    ...
                    - no
                description: |
                    Whether to add dynamic ARP entry. If set to C(no) either L( ARP
                    mode,/wiki/Manual:IP/ARP#ARP_Modes) entries should be administratively defined
                    in C(/ip arp) submenu.
            address_pool:
                type: str
                ignore: true
                description: |
                    L( IP pool,/wiki/Manual:IP/Pools), from which to take IP addresses for the
                    clients. If set to static-only, then only the clients that have a static lease
                    (added in L( lease,#Leases) submenu) will be allowed.
            ...
            relay:
                ...
                description: |
                    ...
                    exists in the C(/ip dhcp-server) submenu.
            src_address:
                type: str
                default: 0.0.0.0
                description: |
