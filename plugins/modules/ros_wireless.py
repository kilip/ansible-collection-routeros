...
options:
  ...
  config:
    ...
    suboptions:
      ...
      area:
        type: str
        description: Identifies group of wireless networks. This value is announced by AP, and can be matched in L(connect-list, #Connect_List) by **area-prefix**. This is a proprietary extension.
      arp:
        type: str
        choices:
          - disabled
          ...
          - reply-only
        default: enabled
        description: L(C(Read more >>), https://wiki.mikrotik.com/wiki/Manual:IP/ARP#ARP_Modes)
      arp_timeout:
        type: str
        default: auto
      ...
      bridge_mode:
        ...
        choices:
          ...
          - enabled
        default: enabled
        description: Allows to use station-bridge mode. L(C(Read more >>), https://wiki.mikrotik.com/wiki/Manual:Wireless_Station_Modes#Mode_station-bridge)
      burst_time:
        type: int
        default: 0
      ...
      default_ap_tx_limit:
        type: int
        default: 0
        description: This is the value of **ap-tx-limit** for clients that do not match any entry in the L(access-list, #Access_List). 0 means no limit.
      default_authentication:
        type: bool
        default: True
        description: For AP mode, this is the value of **authentication** for clients that do not match any entry in the L(access-list, #Access_List). For station mode, this is the value of **connect** for APs that do not match any entry in the L(connect-list, #Connect_List)
      default_client_tx_limit:
        type: int
        default: 0
        description: This is the value of **client-tx-limit** for clients that do not match any entry in the L(access-list, #Access_List). 0 means no limit
      default_forwarding:
        type: bool
        default: True
        description: This is the value of **forwarding** for clients that do not match any entry in the L(access-list, #Access_List)
      ...
      frequency:
        ...
        description: |
          ...
          *Note*: If using mode "superchannel", any frequency supported by the card will be accepted, but on the RouterOS client, any non-standard frequency must be configured in the L(scan-list, #scan-list), otherwise it will not be scanning in non-standard range. In Winbox, scanlist frequencies are in *bold*, any other frequency means the clients will need scan-list configured.
      frequency_mode:
        type: str
        choices:
          - manual-txpower
      ...
      hw_protection_mode:
        ...
        choices:
          ...
          - none
          - rts-cts
        description: Frame protection support property L(C(read more >>), #Frame_protection_support_.28RTS.2FCTS.29)
      hw_protection_threshold:
        type: int
        default: 0
        description: Frame protection support propertyL(C(read more >>), #Frame_protection_support_.28RTS.2FCTS.29)
      hw_retries:
        type: int
        default: 7
      ...
      multicast_helper:
        ...
        default: default
        description: |
          When set to **full**, multicast packets will be sent with a unicast destination MAC address, resolving L(multicast problem, https://wiki.mikrotik.com/wiki/Manual:Multicast_detailed_example#Multicast_and_Wireless) on the wireless link. This option should be enabled only on the access point, clients should be configured in **station-bridge** mode. Available starting from v5.15.
      ...
      periodic_calibration:
        ...
        choices:
          ...
          - enabled
        default: default
        description: Setting *default* enables periodic calibration if L(info, #Info) **default-periodic-calibration** property is *enabled*. Value of that property depends on the type of wireless card. This property is only effective for cards based on Atheros chipset.
      ...
      rate_set:
        ...
        description: |
          ...
          - *configured* - use values from **basic-rates**, **supported-rates**, **basic-mcs**, **mcs**. L(C(Read more >>), #Basic_and_MCS_Rate_table).
      rx_chains:
        type: list
        choices:
          - 0
      ...
      security_profile:
        type: str
        default: default
        description: Name of profile from L(security-profiles, #Security_Profiles)
      skip_dfs_channels:
        type: str
        default: disabled
      ...
      station_roaming:
        ...
        choices:
          ...
          - enabled
        default: disabled
        description: Station Roaming feature is available only for 802.11 wireless protocol and only for station modes. L(C(Read more >>), #Station-Roaming)
      supported_rates_ag:
        type: list
        choices:
          - 12Mbps
      ...
      update_stats_interval:
        ...
        description: |
          ...
          Access to L(registration-table, #Registration_Table) also triggers update of these values.
      ...
      wmm_support:
        ...
        choices:
          ...
          - required
        default: disabled
        description: Specifies whether to enable L(WMM, https://wiki.mikrotik.com/wiki/Manual:WMM).
      wps_mode:
        type: str
        choices:
          - disabled
        ...
        description: L(C(Read more >>), #WPS_Server)
"""
...
# /interface wireless
# set comment="wlan1 comment" name=wlan1 security-profile=to-olympus
#
...
from ..module_utils.resources.interface.wireless.wireless import (
    WirelessResource,
)
