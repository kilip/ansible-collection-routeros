        ...
        suboptions:
            ...
            arp_timeout:
                ...
                description: |
                    ...
                    L(IP/Settings,https://wiki.mikrotik.com/wiki/Manual:IP/Settings), default is
                    30s.
            auto_mac:
                type: str
                default: yes
            ...
            fast_forward:
                ...
                description: |
                    ...
                    L(FastPath,https://wiki.mikrotik.com/wiki/Manual:Fast_Path) section.
            forward_delay:
                type: str
                default: 00:00:15
                description: |
            ...
            protocol_mode:
                ...
                description: |
                    ...
                    done by setting the protocol-mode to C(none).
            pvid:
                type: str
                default: 1
                description: |
