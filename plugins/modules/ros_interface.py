...
options:
  ...
  config:
    ...
    suboptions:
      comment:
        type: str
        description: Short note for interface resource
      disabled:
        type: bool
        default: False
...
# /interface
# set comment="ether2 comment" mtu=1500 name=ether2
# set comment="ether3 comment" disabled=yes mtu=1500 name=ether3
#
