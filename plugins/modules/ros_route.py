    ...
    config:
        ...
        suboptions:
            ...
            distance:
                ...
                default: 1
                description: |
                    Value used in L(route selection,#Route_selection). Routes with smaller distance
            ...
            gateway:
                ...
                description: |
                    ...
                    packets should be sent to. L(Connected routes,#Connected_routes) and routes with
                    ...
                    reached through one of routers interfaces (but see L(nexthop
                    lookup,#Nexthop_lookup)). L(ECMP,#ECMP) routes have more than one gateway value.
            ...
            pref_src:
                ...
                description: |
                    ...
                    prefix of the route (L(an example,#Route_lookup_example)).
            route_tag:
                type: int
                description: |
            ...
            routing_mark:
                ...
                description: |
                    ...
                    same as main. Packets that are marked by L(firewall,/wiki/Manual:IP/Firewall).
            ...
            target_scope:
                ...
                description: |
                    ...
                    through which a nexthop of this route can be resolved. See L(nexthop
                    lookup,#Nexthop_lookup). For iBGP value is set to 30 by default.
            type:
                type: str
                default: unicast
                choices:
