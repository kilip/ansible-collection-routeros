...
options:
    state:
        ...
        default: merged
        description:
            - I(merged) M(ros_firewall_filter) will update existing C(/ip firewall filter) configuration, or create new C(/ip firewall filter) when resource not found
            - I(replaced) M(ros_firewall_filter) will restore existing C(/ip firewall filter) configuration to its default value, then update existing resource with the new configuration. If the resource C(/ip firewall filter) not found, M(ros_firewall_filter) will create resource in C(/ip firewall filter)
            - I(overridden) M(ros_firewall_filter) will remove any resource in C(/ip firewall filter) first, and then create new C(/ip firewall filter) resources.
