...
from ......plugins.modules import ros_bridge_port

module_fixtures = load_module_fixtures("interface.bridge.bridge_port.yaml")


class TestRosBridgePortModule(TestResourceModules):
