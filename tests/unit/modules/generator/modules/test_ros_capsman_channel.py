...
from ......plugins.modules import ros_capsman_channel

module_fixtures = load_module_fixtures("capsman.capsman_channel.yaml")


class TestRosCapsmanChannelModule(TestResourceModules):
